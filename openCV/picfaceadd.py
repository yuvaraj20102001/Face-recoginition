...
path = 'C:/Users/test/AppData/Local/Programs/Python/Python310/lib/site-packages/cv2/data/'
...
witch = cv2.imread('programingfiles/filter/witch.jpg')
...
for (x,y,w,h) in faces:
    ...
    dst = cv2.addWeighted(roi_bg,0.3,roi_fg,0.7,gamma=0.5)
